                        ...
                        <div class="swiper mySwiper">
                                <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                                <img src="assets/images/homeImg1.jpg" alt="" class="home-img">
                                                ...
                                                <div class="home-details">
                                                        ...
                                                        <a href="{{route('login')}}" class="button">Login Untuk Pegawai</a>
                                                        
                                                </div>
                                        </div>

                                        <div class="swiper-slide">
                                                <img src="assets/images/homeImg2.jpg" alt="" class="home-img">
                                        ...
                                        <div class="swiper-slide">
                                                <img src="assets/images/homeImg3.jpg" alt="" class="home-img">
        ...
        <section class="section about" id="about">
                <div class="about-content container">
                        <div class="about-imageContent">
                                <img src="assets/images/aboutImg.jpg" alt="" class="about-img">
                        ...
                        <div class="about-details">
                                ...
                                <div class="about-buttons flex">
                                        <a href="{{route('create')}}"class="button">Pesan Menu Coffee</button>
                    ...
                    <div class="menu-content">
                            <div class="menu-items">
                                    <div class="menu-item flex">
                                            <img src="assets/images/menuImg1.png" alt="" class="menu-img">
            ...
            <div class="brand-container container">
                    ...
                    <div class="brand-images">
                            <div class="brand-image">
                                    <img src="assets/images/brandImg1.png" alt="" class="brand-img">
                            </div>
                            <div class="brand-image">
                                    <img src="assets/images/brandImg2.png" alt="" class="brand-img">
                            </div>
                            <div class="brand-image">
                                    <img src="assets/images/brandImg3.png" alt="" class="brand-img">
                            </div>
                            <div class="brand-image">
                                    <img src="assets/images/brandImg4.png" alt="" class="brand-img">
                            </div>
                            <div class="brand-image">
                                    <img src="assets/images/brandImg5.png" alt="" class="brand-img">
                            </div>
                    </div>
            </div>
        </section>
                    ...
                    <div class="tesitmonial swiper mySwiper">
                            <div class="swiper-wrapper">
                                    <div class="testi-content swiper-slide flex">
                                            <img src="/assets/images/profileImg2.jpg" alt="" class="review-img">
